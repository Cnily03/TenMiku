...
A SDK to query public data and its derivative applications of *Project Sekai: Colorful Stage! feat. Hatsune Miku*.

## Disclaimer and Legal Notice

The declared license(s) and other legal documents, in, or derived from this respository, only apply to the portions of this repository that have full intellectual property rights. All assets and data fetched from external sources and copyright holders are not included.

The credits of fetched materials and information about *Project Sekai: Colorful Stage! feat. Hatsune Miku* (hereinafter referred to as "the game") through this repository belong to their respective owners, including but not limited to [*SEGA*](https://www.sega.jp/), [*Colorful Palette*](https://colorfulpalette.co.jp/), [*Crypton*](https://www.crypton.co.jp/), and/or the agents of the game, including but not limited to [*Nuverse*](https://www.nvsgames.com/), [*Ariel Network*](https://www.tw-pjsekai.com/). This repository has no affiliation with the aforementioned companies or agents.
